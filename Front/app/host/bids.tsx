      ...
      <div>
        {/* Display user information here */}
            <div className='flex justify-around'>
                <button className='bg-white border border-black rounded w-32'>Price UP</button>
                <button className='bg-white border border-black rounded w-32'>Price Down</button>
            </div>
            ...
            <hr className="mt-[20px] w-full border-t border-gray-300 my-4" />
            <div className='flex justify-between'><h1>Highest</h1><span>700$</span></div>
      </div>
    </div>
  </div> 
  )
