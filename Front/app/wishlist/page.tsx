  ...
  return (
    <div className='flex flex-col justify-center items-center p-8 gap-4'>
        <div className='w-[1400px] rounded shadow'>
            <h1 className='font-bold p-4'>WishList({context.allOffers.length})</h1>
            ...
            {context?.allOffers.map((el,i:number)=>
              ...
              <div className="p-2 ">
                      ...
                      <p className="mb-1 font-normal text-gray-200 ">{el.offerDescription} </p>
              </div>
          </div>)}
            </div>
        
        </div>
        <div className='w-[1200px] h-[400px] rounded shadow'>
