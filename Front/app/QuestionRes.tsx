...
const QuestionRes  = () => {
  ...
  return (
    <div className='bg-slate-100 w-3/5 h-auto ml-80 rounded mt-20 mb-20'>
     ...
     {show1 && <div className=' w-full h-28 bg-slate-200'><p className='pt-8 pr-6 pl-6 text-justify'>We verify personal profiles and listings to make home sharing simple, enjoyable and secure for millions of hosts and guests around the world. <Link href='' className='underline'>Learn more about RentaVilla...</Link><AiFillCaretUp/></p></div>
} 
...
<button className='shadow-xl w-full h-24 font-bold text-lg  pt-3' onClick={()=>{setShow4(!show4)}}> What happens if I need to cancel due to a problem with the property or host?{!show4 && < AiFillCaretDown/>} </button>
     {show4 &&  <div className=' w-full h-28 bg-slate-200'>  <p className='pt-8 pr-6 pl-6 text-justify'>If there is a problem, you can usually find a solution by sending a message to your host. If the host can't help you, contact RentaVilla within 24 hours of noticing the problem.<Link href='' className='underline'> Learn more </Link><AiFillCaretUp/></p></div>
}  
<button className='shadow-xl w-full h-24 font-bold text-lg  pt-3' onClick={()=>{setShow5(!show5)}}> Need more informations? {!show5 && < AiFillCaretDown/>} </button>
     {show5 &&  <div className=' w-full h-28 bg-slate-200'> <p className='pt-8 pr-6 pl-6 text-justify'>  You can find more answers to your questions in the Help Center.<Link href='' className='underline'> Learn more </Link><AiFillCaretUp/></p></div>
}  
