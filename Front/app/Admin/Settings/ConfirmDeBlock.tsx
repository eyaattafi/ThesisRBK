...
const ConfirmDeBlock: React.FC <ConfirmBlockProps> = ({ onConfirm, onCancel }) => {
  return (
    <div className="fixed top-0 left-0 right-0 bottom-0 text-center flex items-center justify-center bg-transparent rounded shadow-2xl">
      <div className="bg-white p-11 h-1/3 w-1/3 border-4 border-orange-950  rounded shadow-md">
        <p className=" text-xl text-orange-950 font-bold mb-10 mt-6">Are you sure you want to deblock this user? This User will be able to use his account again. </p>
